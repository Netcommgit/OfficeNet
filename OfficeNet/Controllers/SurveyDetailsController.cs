...
namespace OfficeNet.Controllers
{
    ...
    public class SurveyDetailsController : ControllerBase
    {
        ...
        [Authorize]
        public async Task<IActionResult> UserSurveyListAsync(string UserId, bool IsSubmitted, int PageNo, int PageSize)
        {
            try
            {
        ...
        [Authorize]
        public async Task<IActionResult> GetSurveyQuestionsResponse(int surveyId, string userId)
        {
            try
            {
        ...
        [Authorize]
        public async Task<IActionResult> SaveSurveyQuestionsResponseByUserId(SaveSurveyResponse surveyResponse, string userId)
        {
            try
            {
